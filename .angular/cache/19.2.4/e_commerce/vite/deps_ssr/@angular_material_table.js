...
} from "./chunk-FI3MQVHF.js";
import {
  MatCommonModule
} from "./chunk-M3LQQC5L.js";
import {
  BidiModule,
  Directionality
} from "./chunk-BSM7QS5V.js";
import {
  Platform,
  _isNumberValue,
  coerceElement,
  coerceNumberProperty
} from "./chunk-JCWK5VT2.js";
import {
  DOCUMENT
} from "./chunk-SXXNXEYQ.js";
import {
...
var MatTableDataSource = class extends DataSource {
  ...
  _renderData = new import_rxjs7.BehaviorSubject([]);
  /** Stream that emits when a new filter string is set on the data source. */
  _filter = new import_rxjs7.BehaviorSubject("");
  /** Used to react to internal changes of the paginator that are made by the data source itself. */
  _internalPageChanges = new import_rxjs7.Subject();
  /**
  ...
  constructor(initialData = []) {
    super();
    this._data = new import_rxjs7.BehaviorSubject(initialData);
    this._updateChangeSubscription();
  }
  /**
  ...
  _updateChangeSubscription() {
    const sortChange = this._sort ? (0, import_rxjs7.merge)(this._sort.sortChange, this._sort.initialized) : (0, import_rxjs7.of)(null);
    const pageChange = this._paginator ? (0, import_rxjs7.merge)(this._paginator.page, this._internalPageChanges, this._paginator.initialized) : (0, import_rxjs7.of)(null);
    const dataStream = this._data;
    const filteredData = (0, import_rxjs7.combineLatest)([dataStream, this._filter]).pipe((0, import_operators3.map)(([data]) => this._filterData(data)));
    const orderedData = (0, import_rxjs7.combineLatest)([filteredData, sortChange]).pipe((0, import_operators3.map)(([data]) => this._orderData(data)));
    const paginatedData = (0, import_rxjs7.combineLatest)([orderedData, pageChange]).pipe((0, import_operators3.map)(([data]) => this._pageData(data)));
